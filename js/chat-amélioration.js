...
//	(data = {groupId:"", userId:""})
  ...
  //      var userId = data.userId;
   ...
   //     socket.leave(groupId);
	...
	//to show the content when using keyboard
	//function testtrim(){
//var theform=document.trimform;
//trimedname = theform.name.value;
//var trimed_name = trimedname.replace(" ","");
//alert ("The content you have entered:\"" + trimed_name + "\"");
//return false; //it depends on different situation to use this sentence ； 
//}
